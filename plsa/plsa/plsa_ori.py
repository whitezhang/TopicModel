...
def main(document_path, file_path_name, model_path, corpus_path, number_of_topics):
	...
	file_path_set = open(file_path_name, "w")
	...
	plsa = Plsa(corpus, number_of_topics, max_iterations, model_path)
	plsa.train()   
